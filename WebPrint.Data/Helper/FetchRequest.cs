...
namespace WebPrint.Data.Helper
{
    ...
    {
        public static IFetchRequest<TOriginating, TRelated> EagerFetch<TOriginating, TRelated>(
        ...
        public static IFetchRequest<TOriginating, TRelated> EagerFetchMany<TOriginating, TRelated>(
        ...
        public static IFetchRequest<TQueried, TRelated> ThenEagerFetchMany<TQueried, TFetch, TRelated>(
    ...
    public class FetchRequest<TQueried, TFetch> : IFetchRequest<TQueried, TFetch>
    {
        ...
        {
            get { return this.NhFetchRequest.ElementType; }
        }

        public Expression Expression
        {
            get { return this.NhFetchRequest.Expression; }
        }

        public IQueryProvider Provider
        {
            get { return this.NhFetchRequest.Provider; }
        }
